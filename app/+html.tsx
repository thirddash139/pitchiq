  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Daily football puzzle games. How well do you know the beautiful game?" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://pitchiq.games" />
        <meta property="og:title" content="Pitch IQ — Daily Football Puzzles" />
        <meta property="og:description" content="Daily football puzzle games. How well do you know the beautiful game?" />
        ...
        <meta name="twitter:description" content="Daily football puzzle games. How well do you know the beautiful game?" />
